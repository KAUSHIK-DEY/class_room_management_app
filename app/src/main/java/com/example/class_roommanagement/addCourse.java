...
public class addCourse extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Bundle bundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null)
        {
            ...
            else if(str.equals("newcourse"))
            {
                bundle=getIntent().getExtras();
                username=bundle.getString("user");
                Log.d("hello","newcourse");
